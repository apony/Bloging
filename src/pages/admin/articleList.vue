<template>
  <div id="content">
    ...
    <div class="tab-box">
      <el-button-group>
        <el-button :type="type=='article'?'primary':'info'"
                   @click="toggle"><i class="iconfont icon-archives"></i> Article</el-button>
        <el-button :type="type=='demo'?'primary':'info'"
                   @click="toggle"><i class="iconfont icon-play"></i> Demo</el-button>
      </el-button-group>
    </div>
    <div v-if="type=='article'">
      <el-button @click="handleAdd()"
                 class="btn-add">新增+</el-button>
